function sendingEodQueueSpecific() {
  const ss = SpreadsheetApp.openById("14uqbTPA8KLneTdAYg7PuspbNOmKGwVKJQ");
  ...
  // use elow line for morning and afternoon shift
